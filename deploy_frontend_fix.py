...
def run():
    ...
    try:
        ...
        # We need to use 'bash -c' to ensure the PATH export works for the command
        commands = [
        ...
        for cmd in commands:
            ...
            # Print output line by line to handle potential large output
            while True:
        ...
        print("Frontend deployment and restart completed.")
